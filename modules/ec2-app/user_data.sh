...
docker exec -i oracle-xe bash -lc "sqlplus ${db_user}/${db_password}@XEPDB1" < /home/ubuntu/oracle_xe/seed.sql || sleep 60 && docker exec -i oracle-xe bash -lc "sqlplus ${db_user}/${db_password}@XEPDB1" < /home/ubuntu/oracle_xe/seed.sql

# Grant Data Pump Permissions
docker exec -i oracle-xe bash -lc "sqlplus / as sysdba << SYSDBAEOF
...
echo "Connection: ${db_user}/${db_password}@<HOST_IP>:1521/XEPDB1"
